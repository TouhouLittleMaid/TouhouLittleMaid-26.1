...
import com.github.tartaricacid.touhoulittlemaid.entity.passive.component.hook.PortalHook;
...
@MaidComponentDef("teleport")
public class MaidTeleportComponent implements MaidComponent, PortalHook {
    /**
     * 女仆传送到主人处的最大尝试次数
     */
    ...
    public MaidTeleportComponent(EntityMaid entityMaid) {
        maid = entityMaid;
    }
