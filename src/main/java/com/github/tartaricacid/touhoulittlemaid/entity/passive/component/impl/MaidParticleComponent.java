 ...
 * 粒子效果管理器，负责生成各种粒子效果
 */
@MaidComponentDef("particle")
public class MaidParticleComponent implements MaidComponent, BaseTickComponent {
    private final EntityMaid maid;
    private final Level level;
    private final RandomSource random;

    public MaidParticleComponent(EntityMaid entityMaid) {
