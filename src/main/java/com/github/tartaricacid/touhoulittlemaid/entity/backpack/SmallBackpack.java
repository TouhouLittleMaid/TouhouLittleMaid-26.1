...
import static com.github.tartaricacid.touhoulittlemaid.client.resource.bedrock.BedrockModelLoader.SMALL_BACKPACK;
...
public class SmallBackpack extends IMaidBackpack {
    ...
    public EntityModel<EntityMaidRenderState> getBackpackModel(EntityModelSet modelSet) {
        return BedrockModelLoader.getEntityModel(SMALL_BACKPACK);
    }
