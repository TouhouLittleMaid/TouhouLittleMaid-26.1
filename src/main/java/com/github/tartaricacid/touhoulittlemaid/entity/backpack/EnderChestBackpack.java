...
import static com.github.tartaricacid.touhoulittlemaid.client.resource.bedrock.BedrockModelLoader.END_CHEST_BACKPACK;
...
public class EnderChestBackpack extends IMaidBackpack {
    ...
    public EntityModel<EntityMaidRenderState> getBackpackModel(EntityModelSet modelSet) {
        return BedrockModelLoader.getEntityModel(END_CHEST_BACKPACK);
    }
