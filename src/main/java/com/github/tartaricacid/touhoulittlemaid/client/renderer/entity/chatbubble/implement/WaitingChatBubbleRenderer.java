...
public class WaitingChatBubbleRenderer implements IChatBubbleRenderer {
    ...
    public void render(EntityMaidRenderer renderer, EntityGraphics graphics) {
        ...
        if (this.secondaryText == null) {
            graphics.text(font, this.text, 18, (this.height - font.lineHeight) / 2 + 1, 0x000000, false);
        } else {
            graphics.text(font, this.text, 18, 2, 0x000000, false);
            ...
            graphics.text(font, this.secondaryText, 0, 5, SECONDARY_TEXT_COLOR, false);
            graphics.getPoseStack().popPose();
        }
    }
